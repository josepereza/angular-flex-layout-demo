...
const DEMO_APP_ROUTES: Routes = [
  ...
  { path: 'docs', loadChildren: () => import('./layout/layout.module').then(m => m.DocsLayoutModule) },
  {
    path: 'responsive',
  ...
  {
    path: 'issues',
    loadChildren: () => import('./github-issues/github-issues.module').then(m => m.DocsGithubIssuesModule)
  },
  {
    path: 'stackoverflow',
    loadChildren:
